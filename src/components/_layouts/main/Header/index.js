  ...
  return (
    <div className="header shadow bg-white z-20 relative">
      <div className="grid grid-flow-col grid-cols-1 md:grid-cols-4">
        ...
        <div
          className={`${mainMenuToggle} MainMenu absolute top-14 md:block md:relative md:top-0 col-span-3 w-full bg-red-700`}>
        ...
        <div className="flex md:hidden bg-red-700">
          <button
            ...
            <div>
              <img
                className={`${openIcon}`}
                src="/images/icon-hamberger.svg"></img>
              <img
                className={`${closeIcon}`}
                src="/images/icon-close.svg"></img>
            </div>
          </button>
        </div>
      </div>
