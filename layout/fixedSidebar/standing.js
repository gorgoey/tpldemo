                            ...
                            <div className="table w-full">
                                <table className="w-full">
                                    <thead className="bg-white text-sm font-halftime">
                                        <tr>
                                            <th className="w-4"><span>Pos</span></th>
                                            <th className="pl-10 w-4 team"><span>Club</span></th>
                                            <th className="w-4"><span>Pl</span></th>
                                            <th className="w-4"><span>GD</span></th>
                                            <th className="w-4"><span>Pts</span></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {StandingData.map(({s,p,name,pl,gd,pts,imageXS}) => (
                                            <tr key={s} className="tableDark font-halftime h-10 border-b-2 border-grey-400 text-md">
                                                ...
                                                <td className="team" scope="row">
                                                    <a className="flex items-center">
                                                        <span className="badge mr-2" data-widget="club-badge-image" data-size="20">
                                                            <img
                                                                className=""
                                                                src={imageXS}
                                                            />
